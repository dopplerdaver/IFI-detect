#--------------------------------------------
#
# Name:    ICICLE.7.AC.data.ver.2.LWC.R
#
# Purpose: 1) load AC 30-sec averaged (ver2) txt files
#          2) load matching RadIA-mosaic (ver1) algo nc files
#          3) load AC NAW (ver1) nc files
#          4) output 30-sec file with matched data appended
#          5) make plots
#
# How to run:
#
#
# Created: 6.11.2020 dserke
#
# Things to do:
# 1. 
#----------------------------------------------
...
latest.mosaic.ver.num               <- 2.5           # as of 5.19.2021, produced by Serke, corresponds to v2.1 of RadIA-mosaic
...
#latest.30smean.ver.num             <- 3              # as of 10.22.2020, when ECCC sends SNDI-like 2DS field data
latest.30smean.ver.num             <- 4              # as of 12.17.2020, when ECCC sends SNDI-like 2DS field data

# aircraft CNV NAW nc data information
#   latest zen/nad data version number
#latest.NAW.zennad.ver.num           <- 1              # as of 08.13.2020, PRELIM VERSION
latest.NAW.zennad.ver.num           <- 2              # as of 12.20.2020, FINAL VERSION
...
#   params for 20190204 F06 case
#yyyymmdd                            <- "2019-02-04"
#flight.num                          <- 6 
#pri.radar.name                      <- " KMQT"
#hh.min.for.plotting                 <- 12            
#hh.max.for.plotting                 <- 16            
#mm.min.for.plotting                 <- 30
#mm.max.for.plotting                 <- 20
...
##   params for 20190205 F07 case
#yyyymmdd                            <- "2019-02-05"
#flight.num                          <- 7 
#pri.radar.name                      <- " KDVN"
#hh.min.for.plotting                 <- 20            
#hh.max.for.plotting                 <- 20            
#mm.min.for.plotting                 <- 20
#mm.max.for.plotting                 <- 40

##   params for 20190217 F17 case
yyyymmdd                            <- "20190217"
flight.num                          <- 17 
pri.radar.name                      <- " KDVN"
hh.min.for.plotting                 <- 12            
hh.max.for.plotting                 <- 12            
mm.min.for.plotting                 <- 40
mm.max.for.plotting                 <- 40
mm.max.for.plotting                 <- 59

##   params for 20190227 F24 case
#yyyymmdd                            <- "2019-02-26"
#flight.num                          <- "24"
#hh.min.for.plotting                 <- 26           # hh=25 really is hh=01
#hh.max.for.plotting                 <- 26           # hh=26 really is hh=02
#mm.min.for.plotting                 <- 07
#mm.max.for.plotting                 <- 18
...
#############################################################################################
# define NRC CNV version 2 csv format file path
CNV.30s.mean.dir                     <- file.path(paste(base.path.dir, field.campaign, "/data/CNV_30s_mean/ver", latest.30smean.ver.num, "/", sep=""))
CNV.30s.mean.listfiles               <- list.files(path = CNV.30s.mean.dir, include.dirs = FALSE)

## define NRC CNV NAW zen/nad-only PRELIM VERSION nc format file path
#CNV.NAW.zennad.dir                   <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/CNV_NAW_nc/zen_nad/ver", latest.NAW.zennad.ver.num, "/", sep=""))
#CNV.NAW.zennad.nc.listfiles          <- list.files(path = CNV.NAW.zennad.dir , include.dirs = FALSE) 

## define NRC CNV NAW horiz-only PRELIM VERSION nc format file path
#CNV.NAW.horiz.dir                    <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/CNV_NAW_nc/horiz/ver", latest.NAW.horiz.ver.num, "/", sep=""))
#CNV.NAW.horiz.nc.listfiles           <- list.files(path = CNV.NAW.horiz.dir , include.dirs = FALSE)

# define NRC CNV NAW up-down-side FINAL VERSION nc format file path
CNV.NAW.zennad.dir                   <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/CNV_NAW_nc/up-down-side/", sep=""))
CNV.NAW.zennad.nc.listfiles          <- list.files(path = CNV.NAW.zennad.dir , include.dirs = FALSE)
...
if (latest.mosaic.ver.num == 1) {
  ...
  #radia.mosaic.INTS.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/algo_ints/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  #radia.mosaic.INTS.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/algo_ints/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  radia.mosaic.INTS.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/algo_ints/",  yyyymmdd, "/", sep=""))
  radia.mosaic.INTS.nc.listfiles       <- list.files(path = radia.mosaic.INTS.nc.dir ,   include.dirs = FALSE)
  #radia.mosaic.FZDZ.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/fzdz_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  #radia.mosaic.FZDZ.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/fzdz_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  radia.mosaic.FZDZ.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/fzdz_flds/",  yyyymmdd, "/", sep=""))
  radia.mosaic.FZDZ.nc.listfiles       <- list.files(path = radia.mosaic.FZDZ.nc.dir ,   include.dirs = FALSE)
  #radia.mosaic.SLW.nc.dir              <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/slw_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  #radia.mosaic.SLW.nc.dir              <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/slw_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  radia.mosaic.SLW.nc.dir              <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/slw_flds/",  yyyymmdd, "/", sep=""))
  radia.mosaic.SLW.nc.listfiles        <- list.files(path = radia.mosaic.SLW.nc.dir ,    include.dirs = FALSE)
  #radia.mosaic.MIXPHA.nc.dir           <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/mpha_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  #radia.mosaic.MIXPHA.nc.dir           <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/mpha_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  radia.mosaic.MIXPHA.nc.dir           <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/mpha_flds/",  yyyymmdd, "/", sep=""))
  radia.mosaic.MIXPHA.nc.listfiles     <- list.files(path = radia.mosaic.MIXPHA.nc.dir , include.dirs = FALSE)
  #radia.mosaic.PLATES.nc.dir           <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/plat_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  #radia.mosaic.PLATES.nc.dir           <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/plat_flds/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  radia.mosaic.PLATES.nc.dir           <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/plat_flds/",  yyyymmdd, "/", sep=""))
  radia.mosaic.PLATES.nc.listfiles     <- list.files(path = radia.mosaic.PLATES.nc.dir , include.dirs = FALSE)
  #radia.mosaic.MOMS.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/raw_moms/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  #radia.mosaic.MOMS.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/raw_moms/",  substr(CNV.homog.IFI.csv.listfiles, 22, 31), "/", sep=""))
  radia.mosaic.MOMS.nc.dir             <- file.path(paste(base.path.ext.dir, "ICICLE_2019/data/nc_radia_MCCC/v", latest.mosaic.ver.num, "/raw_flds/",  yyyymmdd, "/", sep=""))
...
output.matchup.image.dir             <- file.path(paste(base.path.dir, field.campaign, "/images/flights_indiv/", as.character(yyyymmdd), "_F", flight.num, "/ver",  latest.30smean.ver.num, "/", sep=""))
...
print(paste("  CNV NAW zenith/nadir files are:", sep=""))
print(paste("   ", CNV.NAW.zennad.nc.listfiles, sep=""))
print(paste("  CNV NAW horiz files are: NA", sep=""))
#print(paste("   ", CNV.NAW.horiz.nc.listfiles, sep=""))
print(paste("  CNV NAX files are: NA", sep=""))
print(paste("  CNV lidar files are: NA", sep=""))
...
for (e in 1:length(CNV.NAW.zennad.nc.listfiles)) {
  hh.start.CNV.NAW.zennad.file               <- as.numeric(substr(CNV.NAW.zennad.nc.listfiles[e], 30, 31))
  mm.start.CNV.NAW.zennad.file               <- as.numeric(substr(CNV.NAW.zennad.nc.listfiles[e], 32, 33))
  ss.start.CNV.NAW.zennad.file               <- as.numeric(substr(CNV.NAW.zennad.nc.listfiles[e], 34, 35))
  hh.end.CNV.NAW.zennad.file                 <- as.numeric(substr(CNV.NAW.zennad.nc.listfiles[e], 37, 38))
  mm.end.CNV.NAW.zennad.file                 <- as.numeric(substr(CNV.NAW.zennad.nc.listfiles[e], 39, 40))
  ss.end.CNV.NAW.zennad.file                 <- as.numeric(substr(CNV.NAW.zennad.nc.listfiles[e], 41, 42))
...
if (input.use.CNV.homog.IFI.flag == 1) {
  ...
  mm.diff.for.plotting        <- ((hh.max.for.plotting * 60) + mm.max.for.plotting) - ((hh.min.for.plotting * 60) + mm.min.for.plotting)
  case.time.list.df           <- as.data.frame(cbind(yyyymmdd, flight.num, lapply(pri.radar.name, as.character), 1, hh.min.for.plotting, mm.min.for.plotting, hh.max.for.plotting, mm.max.for.plotting, mm.diff.for.plotting, 1, "NA"), row.names = NULL, stringsAsFactors=FALSE)
...
min.fnum.in.df          <- min(as.numeric(as.character(case.time.list.df$flight.num)))
max.fnum.in.df          <- max(as.numeric(as.character(case.time.list.df$flight.num)))
...
#if (substr(yyyymmdd, 1, 3) == "201") {
#  # which index of files in listfiles is yyyymmdd
#  ind.loop.CNV.file.start <- which(paste("F", flight.num, sep="") == str_match(CNV.30s.mean.listfiles, paste("F", flight.num, sep="")))
#  ind.loop.CNV.file.stop  <- ind.loop.CNV.file.start
#} else if (substr(yyyymmdd, 1, 3) == "ALL") {
#  ind.loop.CNV.file.start <- 1
#  ind.loop.CNV.file.stop  <- length(CNV.30s.mean.listfiles)
#} else {
#  print("  Error in CNV file case list input")
#} # end of if ...

# loop over all CNV 30-s mean single date/flight files in case.time.list.df
print(paste("  Looping from 30-s file number ", ind.loop.CNV.file.start[1], " to file number ", ind.loop.CNV.file.stop[1], sep=""))
for (ii in ind.loop.CNV.file.start[1]:ind.loop.CNV.file.stop[1]) {
  
  print(paste("------------------------------", sep=""))
  print(paste("Manage ICICLE datasets for user-defined case...", sep=""))
  
  #-----------------------------------------------
  # load CNV 30-s mean version X csv data files
  #-----------------------------------------------
  print(paste("  Loading 30-s mean CNV file number ", ii, " named: ", CNV.30s.mean.dir, CNV.30s.mean.listfiles[ii], sep=""))
  CNV.30s.mean.df                    <- read.csv(paste(CNV.30s.mean.dir, CNV.30s.mean.listfiles[ii], sep = ""), header = FALSE, sep = ",", dec = ".", stringsAsFactors=FALSE)
  if (       latest.30smean.ver.num == 2) {
    colnames(CNV.30s.mean.df)          <- c("yyyy-mm-dd_hhmmss", "lat.deg", "lon.deg", "alt.m", "flight.num", "seg.num", "seg.type", "hdg.deg", "dhdg.dt.deg", "roll.deg", "pitch.deg", "pres.hpa", "temp.c", "warm.flag", "rh.aimms.per", "dmax.85.per.L.um", "dmax.99perc.um", "NEV.LWC.gm3", "NEV.TWC.gm3", "frac.sphere.2DC", "frac.irreg.2DC", "frac.needle.2DC", "frac.dend.2DC", "RID1.volt", "RID2.volt", "RID3.volt", "RID.LWC.gm3", "MVD.um", "OAP.conc.num.perm3.>40.um", "OAP.LWC.gm3", "CDP.LWC.gm3")
  } else if (latest.30smean.ver.num == 3) {
    colnames(CNV.30s.mean.df)          <- c("yyyy-mm-dd_hhmmss", "lat.deg", "lon.deg", "alt.m", "flight.num", "seg.num", "seg.type", "hdg.deg", "dhdg.dt.deg", "roll.deg", "pitch.deg", "pres.hpa", "temp.c", "warm.flag", "rh.aimms.per", "dmax.85.per.L.um", "dmax.99perc.um", "NEV.LWC.gm3", "NEV.TWC.gm3", "frac.sphere.2DC", "frac.irreg.2DC", "frac.needle.2DC", "frac.dend.2DC", "RID1.volt", "RID2.volt", "RID3.volt", "RID.LWC.gm3", "MVD.um", "OAP.conc.num.perm3.>40.um", "OAP.LWC.gm3", "CDP.LWC.gm3")
  } else if (latest.30smean.ver.num == 4) {
    colnames(CNV.30s.mean.df)          <- c("yyyy-mm-dd", "hhmmss", "lat.deg", "lon.deg", "alt.m", "flight.num", "seg.num", "seg.type", "hdg.deg", "dhdg.dt.deg", "roll.deg", "pitch.deg", "pres.hpa", "temp.c", "warm.flag", "rh.aimms.per", "MLF.gt10um", "MLF.gt50um", "dmax.liq.85.per.L.um", "dmax.liq.99perc.um", "NEV.1.LWC.gm3", "NEV.1.IWC.gm3", "NEV.2.LWC.gm3", "NEV.2.IWC.gm3", "tot.liq.conc.cm-3", "tot.ice.conc.cm-3", "OAP.LWC.gm-3", "OAP.IWC.gm-3", "MVD.liq.um", "MMD.liq.um", "MVDeq.ice.um", "MMDeq.ice.um", "MVDmax.ice.um", "MMDmax.ice.um", "frac.sphere.2DC", "frac.irreg.2DC", "frac.needle.2DC", "frac.dend.2DC", "frac.sphere.HVPS", "frac.irreg.HVPS", "frac.needle.HVPS", "frac.dend.HVPS", "RID1.volt", "RID2.volt", "RID3.volt", "RID.LWC.gm3", "REFL.LIQ.DBZ", "REFL.ICE.DBZ", "CEP.EXT", "CDP.LWC.gm3")
  } else {
    print("ERROR: Latest 30-s mean version number is not recognized")
  } # end of if (latestsmean.ver.num == ...)
  
  head(CNV.30s.mean.df)
  
  # convert yyyy-mm-dd_hhmmss to hh, mm, and ss fields
  ...
  if (output.matchup.data.flag == 1) {
    ...
    } else if (latest.mosaic.ver.num >= 2 & latest.mosaic.ver.num < 2.5) {
    ...
    } else if (latest.mosaic.ver.num == 2.5) {
      write.table(cbind(" yyyy", " mm", " dd", " f#", " hh", " mm", " ss", " seg#", " seg.t",  " lat.d", " lon.d", " alt.m", " hdg.d", " roll.d", " pitch.d", " pres.mb", " T.c", " warm.fg", " rh.aimms.%", " dmax.85.per.L.um", " MVD.um", " NEV.LWC.gm3", " NEV.TWC.gm3", " RID.LWC.gm3", " CDP.LWC.gm3", " OAP.LWC.gm3", " NAW.zennad.REFL.30s.mean.updown", " NAW.zennad.REFL.30s.std.updown", " NAW.zennad.VEL.30s.mean.updown", " NAW.zennad.VEL.30s.std.updown", " dist.radartoac.km", " int.full.FZDZ.max.vol", " int.sdev.DBZ.FZDZ.max.vol", " int.T.DBZ.FZDZ.max.vol", " int.mean.DBZ.FZDZ.max.vol", " int.block.sdev.DBZ.FZDZ.max.vol", " int.block.median.DBZ.FZDZ.max.vol", " sdev.DBZ.FZDZ.max.vol", " T.DBZ.FZDZ.max.vol", " mean.DBZ.FZDZ.max.vol", " block.sdev.DBZ.FZDZ.max.vol", " block.median.DBZ.FZDZ.max.vol", " mask.DBZ.FZDZ.max.vol", " ZDR.MOMS.FZDZ.max.vol", " RHO.MOMS.FZDZ.max.vol", " KDP.MOMS.FZDZ.max.vol", " int.full.SLW.max.vol", " int.mean.ZDR.corr.SLW.max.vol", " int.sdev.ZDR.SLW.max.vol", " int.mean.KDP.SLW.max.vol", " int.sdev.KDP.SLW.max.vol", " mean.ZDR.corr.SLW.max.vol", " sdev.ZDR.SLW.max.vol", " mean.KDP.SLW.max.vol", " sdev.KDP.SLW.max.vol", " DBZ.MOMS.SLW.max.vol", " RHO.MOMS.SLW.max.vol", " int.full.MIXPHA.max.vol", " int.mean.ZDR.MIXPHA.max.vol", " int.mean.DBZ.MIXPHA.max.vol", " int.temp.MIXPHA.max.vol", " mean.ZDR.MIXPHA.max.vol", " mean.DBZ.MIXPHA.max.vol", " RHO.MOMS.MIXPHA.max.vol", " KDP.MOMS.MIXPHA.max.vol", " int.full.PLATES.max.vol", " int.mean.ZDR.corr.PLATES.max.vol", " int.mean.DBZ.PLATES.max.vol", " int.temp.PLATES.max.vol", " mean.ZDR.corr.PLATES.max.vol", " mean.DBZ.PLATES.max.vol", " RHO.MOMS.PLATES.max.vol", " KDP.MOMS.PLATES.max.vol"), sep = ",", col.names = FALSE, quote = FALSE, append = TRUE, file = paste(base.path.dir, field.campaign, "/data/ICICLE.7_output/ver", latest.mosaic.ver.num, "/", case.time.list.df$yyyymmdd[1], "_F", case.time.list.df$flight.num[1], "_", case.time.list.df$hh.min.for.plotting[1], case.time.list.df$mm.min.for.plotting[1], "to", case.time.list.df$hh.max.for.plotting[dim(case.time.list.df)[1]], case.time.list.df$mm.max.for.plotting[dim(case.time.list.df)[1]], "Z_RadIA-m_v", latest.mosaic.ver.num, "_CNV_v",  latest.30smean.ver.num, ".csv", sep="")) 
    } # end of if (latest.mosaic.ver.num == 1)
  ...
  for (ppp in ind.case.time.list.df.of.30sfile[1]:ind.case.time.list.df.of.30sfile[length(ind.case.time.list.df.of.30sfile)]) { 
    ...
    # for primary radar
    print(paste("  Defining primary NEXRAD location information for F#", case.time.list.df$flight.num[ppp], sep=""))
    NEXRAD.pri.name                        <- paste(case.time.list.df$pri.radar.name[ppp], sep="")
    #NEXRAD.pri.name                        <- paste(" ", as.character(icicle.df$pri.radar.name[ind.flight.num]), sep="")
    ...
    ## for secondary radar
    #if (!is.na(paste("", icicle.df$sec.radar.name[ind.flight.num], sep=""))) {
    #  print(paste("  Defining secondary NEXRAD location information for F#", flight.num, sep=""))
    #  NEXRAD.sec.name                        <- paste(" ", as.character(icicle.df$sec.radar.name[ind.flight.num]), sep="")
    ...
    if (as.numeric(case.time.list.df$hh.min.for.plotting[ppp]) != as.numeric(case.time.list.df$hh.max.for.plotting[ppp])) {
      ind.hhmm.first  <- which(CNV.30s.mean.df$hh == case.time.list.df$hh.min.for.plotting[ppp] & CNV.30s.mean.df$mm >= case.time.list.df$mm.min.for.plotting[ppp])
      ind.hhmm.last   <- which(CNV.30s.mean.df$hh == hh.max.for.plotting & CNV.30s.mean.df$mm <= mm.max.for.plotting)
      ind.hhmm.total  <- c(ind.hhmm.first, ind.hhmm.last)
    } else {
      ind.hhmm.total  <- which(CNV.30s.mean.df$hh == case.time.list.df$hh.min.for.plotting[ppp] & CNV.30s.mean.df$mm >= case.time.list.df$mm.min.for.plotting[ppp] & CNV.30s.mean.df$mm <= case.time.list.df$mm.max.for.plotting[ppp])
    ...
    ind.CNV.NAW.zennad.file.last       <- 0
    ...
    ##for (j in 1:length(user.defined.seg.number.list)) {
      ...
      if (ss.tot.flight.track >= 1400*60) {
      ...
      print(paste("    Searching for representative CNV zen/nad data files...", sep=""))
      #ind.CNV.NAW.zennad.file.closest.by.fnum <- which(as.numeric(substr(CNV.NAW.zennad.nc.listfiles, 2, 3)) == case.time.list.df$flight.num[1])
      ...
      ind.CNV.NAW.zennad.file.closest.by.mmdd   <- which(as.numeric(substr(CNV.NAW.zennad.nc.listfiles, 21, 22)) == as.numeric(substr(case.time.list.df$yyyymmdd[1], 6, 7)) & as.numeric(substr(CNV.NAW.zennad.nc.listfiles, 23, 24)) == as.numeric(substr(case.time.list.df$yyyymmdd[1], 9, 10)))
      ind.CNV.NAW.zennad.file.closest.by.hhmmss <- which(as.numeric(substr(CNV.NAW.zennad.nc.listfiles[ind.CNV.NAW.zennad.file.closest.by.mmdd], 26, 31)) <= as.numeric(paste(CNV.30s.mean.df$hh[j],  CNV.30s.mean.df$mm[j], CNV.30s.mean.df$ss[j], sep="")) & as.numeric(substr(CNV.NAW.zennad.nc.listfiles[ind.CNV.NAW.zennad.file.closest.by.mmdd], 33, 38)) >= as.numeric(paste(CNV.30s.mean.df$hh[j],  CNV.30s.mean.df$mm[j], CNV.30s.mean.df$ss[j], sep="")))
      ind.CNV.NAW.zennad.file.current           <- ind.CNV.NAW.zennad.file.closest.by.mmdd[ind.CNV.NAW.zennad.file.closest.by.hhmmss]
      
      #if (length(ind.CNV.NAW.zennad.file.closest.by.fnum) == 1 & length(ind.CNV.NAW.zennad.file.closest.by.ss) > 1) {
      ##if (length(ind.CNV.NAW.zennad.file.closest.by.hhmmss) == 1) {  
        ...
        #ss.diff.zennad.from.avetime        <- abs(ss.avetime.tot.CNV.NAW.zennad.file - ss.tot.flight.track)
      ...
      #} else if (length(ind.CNV.NAW.zennad.file.closest.by.fnum) > 1 & length(ind.CNV.NAW.zennad.file.closest.by.ss) == 1) {
        
        # find the intersect of closest.by.fnum and closest.by.ss and set to the closest
        #ind.CNV.NAW.zennad.file.closest    <- intersect(ind.CNV.NAW.zennad.file.closest.by.fnum, ind.CNV.NAW.zennad.file.closest.by.ss)
        
        # set NAW file match flag to 1 since flight/time match found
        #CNV.NAW.zennad.nc.file.match.flag  <- 1
      
      #} else if (length(ind.CNV.NAW.zennad.file.closest.by.hhmmss) == 0) {   
      ##} else if (length(ind.CNV.NAW.zennad.file.closest.by.fnum) == 0) {
      
        ## set NAW zen/nad values to NaN in no representative NAW nc file
        #print("      No representative NAW zen/nad file found...")
        #print("        Setting appropriate NAW zen/nad values to NaN")
        ...
        #CNV.NAW.zennad.REFL.30s.mean.zen   <- NaN
        #CNV.NAW.zennad.REFL.30s.mean.nad   <- NaN
        #CNV.NAW.zennad.REFL.30s.std.zen    <- NaN
        #CNV.NAW.zennad.REFL.30s.std.nad    <- NaN
        #CNV.NAW.zennad.VEL.30s.mean.zen    <- NaN
        #CNV.NAW.zennad.VEL.30s.mean.nad    <- NaN
        #CNV.NAW.zennad.VEL.30s.std.zen     <- NaN
        #CNV.NAW.zennad.VEL.30s.std.nad     <- NaN
      ...
      #if (ind.CNV.NAW.zennad.file.closest != ind.CNV.NAW.zennad.file.closest.last & CNV.NAW.zennad.nc.file.match.flag == 1) {  
      if (ind.CNV.NAW.zennad.file.current != ind.CNV.NAW.zennad.file.last) {
        #CNV.NAW.zennad.nc.filename       <- paste(CNV.NAW.zennad.dir, CNV.NAW.zennad.nc.listfiles[ind.CNV.NAW.zennad.file.closest], sep="")
        CNV.NAW.zennad.nc.filename       <- paste(CNV.NAW.zennad.dir, CNV.NAW.zennad.nc.listfiles[ind.CNV.NAW.zennad.file.closest.by.mmdd[ind.CNV.NAW.zennad.file.closest.by.hhmmss]], sep="")
        print(paste("      Current NAW different from last one", sep=""))
        ...
        if (CNV.NAW.zennad.nc$nvars >= 19) {
          ...
          CNV.NAW.zennad.range.updown.m  <- ncvar_get( CNV.NAW.zennad.nc, v2 )
          CNV.NAW.zennad.REFL.updown.dbz <- ncvar_get( CNV.NAW.zennad.nc, v3 )
          CNV.NAW.zennad.VEL.updown.mps  <- ncvar_get( CNV.NAW.zennad.nc, v5 )
          ...
          CNV.NAW.zennad.range.side.m    <- ncvar_get( CNV.NAW.zennad.nc, v15)
          CNV.NAW.zennad.REFL.side.dbz   <- ncvar_get( CNV.NAW.zennad.nc, v16)
          CNV.NAW.zennad.VEL.side.mps    <- ncvar_get( CNV.NAW.zennad.nc, v17)
        } else {
          print("ERROR")
        }  # end of if ()...
        ...
        ind.CNV.NAW.zennad.file.last <- ind.CNV.NAW.zennad.file.current
        
      } else {
        print("      NAW file already loaded")
      }
      ...
      ind.CNV.NAW.zennad.range.updown.m.clos <- which.min(abs(CNV.30s.mean.df$alt.m[j] - CNV.NAW.zennad.range.updown.m))
        
      #browser()
        
      #  calculate some statistical values from NAW zenith/nadir returns  
      #NAW.range.offset                       <- 2
      #CNV.NAW.zennad.REFL.30s.mean.zen     <- round(mean(CNV.NAW.zennad.REFL.updown.dbz[ind.CNV.NAW.zennad.range.updown.m.clos + NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.REFL.30s.mean.nad     <- round(mean(CNV.NAW.zennad.REFL.updown.dbz[ind.CNV.NAW.zennad.range.updown.m.clos - NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      CNV.NAW.zennad.REFL.30s.mean.updown    <- round(mean(CNV.NAW.zennad.REFL.updown.dbz[ind.CNV.NAW.zennad.range.updown.m.clos, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.REFL.30s.std.zen      <- round(sd(  CNV.NAW.zennad.REFL.updown.dbz[ind.CNV.NAW.zennad.range.updown.m.clos + NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.REFL.30s.std.nad      <- round(sd(  CNV.NAW.zennad.REFL.updown.dbz[ind.CNV.NAW.zennad.range.updown.m.clos - NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      CNV.NAW.zennad.REFL.30s.std.updown     <- round(sd(  CNV.NAW.zennad.REFL.updown.dbz[ind.CNV.NAW.zennad.range.updown.m.clos, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.VEL.30s.mean.zen      <- round(mean(CNV.NAW.zennad.VEL.updown.mps[ ind.CNV.NAW.zennad.range.updown.m.clos + NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.VEL.30s.mean.nad      <- round(mean(CNV.NAW.zennad.VEL.updown.mps[ ind.CNV.NAW.zennad.range.updown.m.clos - NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      CNV.NAW.zennad.VEL.30s.mean.updown     <- round(mean(CNV.NAW.zennad.VEL.updown.mps[ ind.CNV.NAW.zennad.range.updown.m.clos, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.VEL.30s.std.zen       <- round(sd(  CNV.NAW.zennad.VEL.updown.mps[ ind.CNV.NAW.zennad.range.updown.m.clos + NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      #CNV.NAW.zennad.VEL.30s.std.nad       <- round(sd(  CNV.NAW.zennad.VEL.updown.mps[ ind.CNV.NAW.zennad.range.updown.m.clos - NAW.range.offset, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      CNV.NAW.zennad.VEL.30s.std.updown      <- round(sd(  CNV.NAW.zennad.VEL.updown.mps[ ind.CNV.NAW.zennad.range.updown.m.clos, ind.CNV.NAW.zennad.TIME.30s.start[1]:ind.CNV.NAW.zennad.TIME.30s.end[length(ind.CNV.NAW.zennad.TIME.30s.end)]], na.rm = TRUE), digits = 2)
      ...
      print(paste("      NAW zen/nad REFL matrix size = ",     dim(CNV.NAW.zennad.REFL.updown.dbz), sep=""))
      ...
      #print(paste("      NAW zen/nad REFL 30s mean (zen):",    CNV.NAW.zennad.REFL.30s.mean.zen))
      #print(paste("      NAW zen/nad REFL 30s mean (nad):",    CNV.NAW.zennad.REFL.30s.mean.nad))
      print(paste("      NAW zen/nad REFL 30s mean (u/d):",    CNV.NAW.zennad.REFL.30s.mean.updown))
      #print(paste("      NAW zen/nad REFL 30s std (zen):",     CNV.NAW.zennad.REFL.30s.std.zen))
      #print(paste("      NAW zen/nad REFL 30s std (nad):",     CNV.NAW.zennad.REFL.30s.std.nad))
      print(paste("      NAW zen/nad REFL 30s std (u/d):",     CNV.NAW.zennad.REFL.30s.std.updown))
      #print(paste("      NAW zen/nad VEL 30s mean (zen):",     CNV.NAW.zennad.VEL.30s.mean.zen))
      #print(paste("      NAW VEL 30s mean (nad):",             CNV.NAW.zennad.VEL.30s.mean.nad))
      print(paste("      NAW zen/nad VEL 30s mean (u/d):",     CNV.NAW.zennad.VEL.30s.mean.updown))
      #print(paste("      NAW zen/nad VEL 30s std (zen):",      CNV.NAW.zennad.VEL.30s.std.zen))
      #print(paste("      NAW zen/nad VEL 30s std (nad):",      CNV.NAW.zennad.VEL.30s.std.nad))
      print(paste("      NAW zen/nad VEL 30s std (u/d):",      CNV.NAW.zennad.VEL.30s.std.updown))
      ...
      #} else if (ind.CNV.NAW.zennad.file.closest == ind.CNV.NAW.zennad.file.closest.last & CNV.NAW.zennad.nc.file.match.flag == 1) {
      #  print("        Closest mosaic time is same as the last, which is already loaded")
      #} else if (ind.CNV.NAW.zennad.file.closest != ind.CNV.NAW.zennad.file.closest.last & CNV.NAW.zennad.nc.file.match.flag == 0) { 
      #  print("        No time matched CNV NAW found")
      ...
      if (latest.mosaic.ver.num == 1) {
        ...
        #   from INTS
        TEMP.CELSIUS.pix[j]              <- TEMP.CELSIUS[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]] 
        FZDZ.INT.pix[j]                  <- FZDZ.INT[                ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]] 
        SLW.INT.pix[j]                   <- SLW.INT[                 ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]] 
        MIXPHA.INT.pix[j]                <- MIXPHA.INT[              ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]] 
        PLATES.INT.pix[j]                <- PLATES.INT[              ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]] 
        RADIA2.VAL.pix[j]                <- RADIA2.VAL[              ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]] 
        #   from MOMS
        RHO.MOMS.pix[j]                  <- RHO.MOMS[                ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        DBZ.MOMS.pix[j]                  <- DBZ.MOMS[                ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        ZDR.MOMS.pix[j]                  <- ZDR.MOMS[                ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        KDP.MOMS.pix[j]                  <- KDP.MOMS[                ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        #   for FZDZ
        mask.DBZ.FZDZ.pix[j]             <- mask.DBZ.FZDZ[           ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        mean.DBZ.FZDZ.pix[j]             <- mean.DBZ.FZDZ[           ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        T.DBZ.FZDZ.pix[j]                <- T.DBZ.FZDZ[              ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        sdev.DBZ.FZDZ.pix[j]             <- sdev.DBZ.FZDZ[           ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        block.sdev.DBZ.FZDZ.pix[j]       <- block.sdev.DBZ.FZDZ[     ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        block.median.DBZ.FZDZ.pix[j]     <- block.median.DBZ.FZDZ[   ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.sdev.DBZ.FZDZ.pix[j]         <- int.sdev.DBZ.FZDZ[       ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.T.DBZ.FZDZ.pix[j]            <- int.T.DBZ.FZDZ[          ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.mean.DBZ.FZDZ.pix[j]         <- int.mean.DBZ.FZDZ[       ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.block.sdev.DBZ.FZDZ.pix[j]   <- int.block.sdev.DBZ.FZDZ[ ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.block.median.DBZ.FZDZ.pix[j] <- int.block.median.DBZ.FZDZ[ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.full.FZDZ.pix[j]             <- int.full.FZDZ[           ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        #   for SLW
        mask.ZDR.SLW.pix[j]              <- mask.ZDR.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        mean.ZDR.SLW.pix[j]              <- mean.ZDR.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        mean.ZDR.corr.SLW.pix[j]         <- mean.ZDR.corr.SLW[       ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        sdev.ZDR.SLW.pix[j]              <- sdev.ZDR.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        mask.KDP.SLW.pix[j]              <- mask.KDP.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        sdev.KDP.SLW.pix[j]              <- sdev.KDP.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        mean.KDP.SLW.pix[j]              <- mean.KDP.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.mean.ZDR.corr.SLW.pix[j]     <- int.mean.ZDR.corr.SLW[   ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.sdev.ZDR.SLW.pix[j]          <- int.sdev.ZDR.SLW[        ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.mean.KDP.SLW.pix[j]          <- int.mean.KDP.SLW[        ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.sdev.KDP.SLW.pix[j]          <- int.sdev.KDP.SLW[        ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.full.SLW.pix[j]              <- int.full.SLW[            ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        #   for MIXPHA
        int.mean.ZDR.MIXPHA.pix[j]       <- int.mean.ZDR.MIXPHA[     ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.mean.DBZ.MIXPHA.pix[j]       <- int.mean.DBZ.MIXPHA[     ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.temp.MIXPHA.pix[j]           <- int.temp.MIXPHA[         ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.full.MIXPHA.pix[j]           <- int.full.MIXPHA[         ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        #   for PLATES
        int.mean.ZDR.PLATES.pix[j]       <- int.mean.ZDR.PLATES[     ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.mean.DBZ.PLATES.pix[j]       <- int.mean.DBZ.PLATES[     ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.temp.PLATES.pix[j]           <- int.temp.PLATES[         ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
        int.full.PLATES.pix[j]           <- int.full.PLATES[         ind.closest.mosaic.lon.pixel[j], ind.closest.mosaic.lat.pixel[j], ind.closest.mosaic.pres.pixel[j]]
      ...
      if (output.matchup.data.flag == 1) {
        ...
        if (latest.mosaic.ver.num == 1) {
          ...
          ## NEXT FEW LINES OUTPUT int.full.{ALGO}.max.vol
          #write.table(cbind(                               " yyyymmdd",                     " flight.num",             " hh",             " mm",             " ss",                      " seg.num",                      " seg.type",                       " lat.deg",                      " lon.deg",                      " alt.m",                      " hdg.deg",                      " roll.deg",                      " pitch.deg",                      " pres.hpa",                      " temp.c",                      " warm.flag",                      " rh.aimms.per",                      " dmax.85.per.L.um",                      " MVD.um",                      " NEV.LWC.gm3",                      " NEV.TWC.gm3",                      " RID.LWC.gm3",                      " CDP.LWC.gm3",                      " OAP.LWC.gm3", "CNV.NAW..zennadREFL.30s.mean.zen", "CNV.NAW.zennad.REFL.30s.mean.nad", "CNV.NAW.zennad.REFL.30s.std.zen", "CNV.NAW.zennad.REFL.30s.std.nad", "CNV.NAW.zennad.VEL.30s.mean.zen", "CNV.NAW..zennadVEL.30s.mean.nad", "CNV.NAW.zennad.VEL.30s.std.zen", "CNV.NAW.zennad.VEL.30s.std.nad",                  " dist.radartoac.km",                " int.full.FZDZ.max.vol",               " int.sdev.DBZ.FZDZ.max.vol",               " int.T.DBZ.FZDZ.max.vol",               " int.mean.DBZ.FZDZ.max.vol",               " int.block.sdev.DBZ.FZDZ.max.vol",               " int.block.median.DBZ.FZDZ.max.vol",               " sdev.DBZ.FZDZ.max.vol",               " T.DBZ.FZDZ.max.vol",               " mean.DBZ.FZDZ.max.vol",               " block.sdev.DBZ.FZDZ.max.vol",               " block.median.DBZ.FZDZ.max.vol",               " mask.DBZ.FZDZ.max.vol",               " ZDR.MOMS.FZDZ.max.vol",               " RHO.MOMS.FZDZ.max.vol",               " KDP.MOMS.FZDZ.max.vol",               " int.full.SLW.max.vol",               " int.mean.ZDR.corr.SLW.max.vol",               " int.sdev.ZDR.SLW.max.vol",               " int.mean.KDP.SLW.max.vol",               " int.sdev.KDP.SLW.max.vol",               " mean.ZDR.corr.SLW.max.vol",               " sdev.ZDR.SLW.max.vol",               " mean.KDP.SLW.max.vol",               " sdev.KDP.SLW.max.vol",               " DBZ.MOMS.SLW.max.vol",               " RHO.MOMS.SLW.max.vol",               " int.full.MIXPHA.max.vol",          " int.mean.ZDR.corr.MIXPHA.max.vol",               " int.mean.DBZ.MIXPHA.max.vol",               " int.temp.MIXPHA.max.vol",               " mean.ZDR.corr.MIXPHA.max.vol",               " mean.DBZ.MIXPHA.max.vol",               " RHO.MOMS.MIXPHA.max.vol",               " KDP.MOMS.MIXPHA.max.vol",               " int.full.PLATES.max.vol",               " int.mean.ZDR.PLATES.max.vol",                " int.mean.DBZ.PLATES.max.vol",              " int.temp.PLATES.max.vol",               " mean.ZDR.corr.PLATES.max.vol",               " mean.DBZ.PLATES.max.vol",               " RHO.MOMS.PLATES.max.vol",                " KDP.MOMS.PLATES.max.vol"                 
          write.table(cbind(as.numeric(substr(yyyymmdd,1,4)), as.numeric(substr(yyyymmdd,6,7)), as.numeric(substr(yyyymmdd,9,10)), case.time.list.df$flight.num[ppp], as.numeric(hh[j]), as.numeric(mm[j]), as.numeric(ss[j]), CNV.30s.mean.df$seg.num[j], CNV.30s.mean.df$seg.type[j],  CNV.30s.mean.df$lat.deg[j], CNV.30s.mean.df$lon.deg[j], CNV.30s.mean.df$alt.m[j], CNV.30s.mean.df$hdg.deg[j], CNV.30s.mean.df$roll.deg[j], CNV.30s.mean.df$pitch.deg[j], CNV.30s.mean.df$pres.hpa[j], CNV.30s.mean.df$temp.c[j], CNV.30s.mean.df$warm.flag[j], CNV.30s.mean.df$rh.aimms.per[j], CNV.30s.mean.df$dmax.85.per.L.um[j], CNV.30s.mean.df$MVD.um[j], CNV.30s.mean.df$NEV.LWC.gm3[j], CNV.30s.mean.df$NEV.TWC.gm3[j], CNV.30s.mean.df$RID.LWC.gm3[j], CNV.30s.mean.df$CDP.LWC.gm3[j], CNV.30s.mean.df$OAP.LWC.gm3[j],   CNV.NAW.zennad.REFL.30s.mean.updown,   CNV.NAW.zennad.REFL.30s.std.updown,   CNV.NAW.zennad.VEL.30s.mean.updown,   CNV.NAW.zennad.VEL.30s.std.updown, round(dist.radartoac.km[j], digits=2),  round(int.full.FZDZ.max.vol, digits=2), round(int.sdev.DBZ.FZDZ.max.vol, digits=2), round(int.T.DBZ.FZDZ.max.vol, digits=2), round(int.mean.DBZ.FZDZ.max.vol, digits=2), round(int.block.sdev.DBZ.FZDZ.max.vol, digits=2), round(int.block.median.DBZ.FZDZ.max.vol, digits=2), round(sdev.DBZ.FZDZ.max.vol, digits=2), round(T.DBZ.FZDZ.max.vol, digits=2), round(mean.DBZ.FZDZ.max.vol, digits=2), round(block.sdev.DBZ.FZDZ.max.vol, digits=2), round(block.median.DBZ.FZDZ.max.vol, digits=2), round(mask.DBZ.FZDZ.max.vol, digits=2), round(ZDR.MOMS.FZDZ.max.vol, digits=2), round(RHO.MOMS.FZDZ.max.vol, digits=2), round(KDP.MOMS.FZDZ.max.vol, digits=2), round(int.full.SLW.max.vol, digits=2), round(int.mean.ZDR.corr.SLW.max.vol, digits=2), round(int.sdev.ZDR.SLW.max.vol, digits=2), round(int.mean.KDP.SLW.max.vol, digits=2), round(int.sdev.KDP.SLW.max.vol, digits=2), round(mean.ZDR.corr.SLW.max.vol, digits=2), round(sdev.ZDR.SLW.max.vol, digits=2), round(mean.KDP.SLW.max.vol, digits=2), round(sdev.KDP.SLW.max.vol, digits=2), round(DBZ.MOMS.SLW.max.vol, digits=2), round(RHO.MOMS.SLW.max.vol, digits=2), round(int.full.MIXPHA.max.vol, digits=2), round(int.mean.ZDR.MIXPHA.max.vol, digits=2), round(int.mean.DBZ.MIXPHA.max.vol, digits=2), round(int.temp.MIXPHA.max.vol, digits=2), round(mean.ZDR.corr.MIXPHA.max.vol, digits=2), round(mean.DBZ.MIXPHA.max.vol, digits=2), round(RHO.MOMS.MIXPHA.max.vol, digits=2), round(KDP.MOMS.MIXPHA.max.vol, digits=2), round(int.full.PLATES.max.vol, digits=2), round(int.mean.ZDR.PLATES.max.vol, digits=2), round(int.mean.DBZ.PLATES.max.vol, digits=2), round(int.temp.PLATES.max.vol, digits=2), round(mean.ZDR.corr.PLATES.max.vol, digits=2), round(mean.DBZ.PLATES.max.vol, digits=2), round(RHO.MOMS.PLATES.max.vol, digits=2), round(KDP.MOMS.PLATES.max.vol, digits=2)), sep = ", ", col.names = FALSE, quote = FALSE, append = TRUE, na = "NaN", file = paste(base.path.dir, field.campaign, "/data/ICICLE.7_output/ver", latest.mosaic.ver.num, "/",  case.time.list.df$yyyymmdd[1], "_F", case.time.list.df$flight.num[1], "_", case.time.list.df$hh.min.for.plotting[1], case.time.list.df$mm.min.for.plotting[1], "to", case.time.list.df$hh.max.for.plotting[dim(case.time.list.df)[1]], case.time.list.df$mm.max.for.plotting[dim(case.time.list.df)[1]], "Z_RadIA-m_v",  latest.mosaic.ver.num, "_CNV_v", latest.30smean.ver.num, ".csv", sep=""))
          print(      cbind(as.numeric(substr(yyyymmdd,1,4)), as.numeric(substr(yyyymmdd,6,7)), as.numeric(substr(yyyymmdd,9,10)), case.time.list.df$flight.num[ppp], as.numeric(hh[j]), as.numeric(mm[j]), as.numeric(ss[j]), CNV.30s.mean.df$seg.num[j], CNV.30s.mean.df$seg.type[j],  CNV.30s.mean.df$lat.deg[j], CNV.30s.mean.df$lon.deg[j], CNV.30s.mean.df$alt.m[j], CNV.30s.mean.df$hdg.deg[j], CNV.30s.mean.df$roll.deg[j], CNV.30s.mean.df$pitch.deg[j], CNV.30s.mean.df$pres.hpa[j], CNV.30s.mean.df$temp.c[j], CNV.30s.mean.df$warm.flag[j], CNV.30s.mean.df$rh.aimms.per[j], CNV.30s.mean.df$dmax.85.per.L.um[j], CNV.30s.mean.df$MVD.um[j], CNV.30s.mean.df$NEV.LWC.gm3[j], CNV.30s.mean.df$NEV.TWC.gm3[j], CNV.30s.mean.df$RID.LWC.gm3[j], CNV.30s.mean.df$CDP.LWC.gm3[j], CNV.30s.mean.df$OAP.LWC.gm3[j],   CNV.NAW.zennad.REFL.30s.mean.updown,   CNV.NAW.zennad.REFL.30s.std.updown,   CNV.NAW.zennad.VEL.30s.mean.updown,   CNV.NAW.zennad.VEL.30s.std.updown, round(dist.radartoac.km[j], digits=2),  round(int.full.FZDZ.max.vol, digits=2), round(int.sdev.DBZ.FZDZ.max.vol, digits=2), round(int.T.DBZ.FZDZ.max.vol, digits=2), round(int.mean.DBZ.FZDZ.max.vol, digits=2), round(int.block.sdev.DBZ.FZDZ.max.vol, digits=2), round(int.block.median.DBZ.FZDZ.max.vol, digits=2), round(sdev.DBZ.FZDZ.max.vol, digits=2), round(T.DBZ.FZDZ.max.vol, digits=2), round(mean.DBZ.FZDZ.max.vol, digits=2), round(block.sdev.DBZ.FZDZ.max.vol, digits=2), round(block.median.DBZ.FZDZ.max.vol, digits=2), round(mask.DBZ.FZDZ.max.vol, digits=2), round(ZDR.MOMS.FZDZ.max.vol, digits=2), round(RHO.MOMS.FZDZ.max.vol, digits=2), round(KDP.MOMS.FZDZ.max.vol, digits=2), round(int.full.SLW.max.vol, digits=2), round(int.mean.ZDR.corr.SLW.max.vol, digits=2), round(int.sdev.ZDR.SLW.max.vol, digits=2), round(int.mean.KDP.SLW.max.vol, digits=2), round(int.sdev.KDP.SLW.max.vol, digits=2), round(mean.ZDR.corr.SLW.max.vol, digits=2), round(sdev.ZDR.SLW.max.vol, digits=2), round(mean.KDP.SLW.max.vol, digits=2), round(sdev.KDP.SLW.max.vol, digits=2), round(DBZ.MOMS.SLW.max.vol, digits=2), round(RHO.MOMS.SLW.max.vol, digits=2), round(int.full.MIXPHA.max.vol, digits=2), round(int.mean.ZDR.MIXPHA.max.vol, digits=2), round(int.mean.DBZ.MIXPHA.max.vol, digits=2), round(int.temp.MIXPHA.max.vol, digits=2), round(mean.ZDR.corr.MIXPHA.max.vol, digits=2), round(mean.DBZ.MIXPHA.max.vol, digits=2), round(RHO.MOMS.MIXPHA.max.vol, digits=2), round(KDP.MOMS.MIXPHA.max.vol, digits=2), round(int.full.PLATES.max.vol, digits=2), round(int.mean.ZDR.PLATES.max.vol, digits=2), round(int.mean.DBZ.PLATES.max.vol, digits=2), round(int.temp.PLATES.max.vol, digits=2), round(mean.ZDR.corr.PLATES.max.vol, digits=2), round(mean.DBZ.PLATES.max.vol, digits=2), round(RHO.MOMS.PLATES.max.vol, digits=2), round(KDP.MOMS.PLATES.max.vol, digits=2)))
          #browser()
        }  # end of if (latest.mosaic.ver.num == 1) 
      } else {
  ...
  CNV.30s.mean.df                 <- cbind(CNV.30s.mean.df, dist.radartoac.km, bearing.radartoac.deg, range.radartoac.km, theta.radartoac.deg)
